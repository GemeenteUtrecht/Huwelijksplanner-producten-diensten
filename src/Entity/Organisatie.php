...
class Organisatie implements StringableInterface
{
	...
	/**
	 * De Producten die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Product[]|null
	 *
	 * @ORM\OneToMany(
	...
	/**
	 * De Product extras die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Product\ProductExtra[]|null
	 *
	 * @ORM\OneToMany(
	 * 		targetEntity="\App\Entity\Product\ProductExtra",
	 * 		mappedBy="bronOrganisatie",
	 * 		fetch="EXTRA_LAZY"
	 * )
	 *
	 */
	public $productenExtras;
	
	/**
	 * De Product groepen die bij deze organisatie horen
	 *
	 * @var \Doctrine\Common\Collections\Collection|\App\Entity\Product\ProductGroep[]|null
	 *
	 * @ORM\OneToMany(
	 * 		targetEntity="\App\Entity\Product\ProductGroep",
	 * 		mappedBy="bronOrganisatie",
	 * 		fetch="EXTRA_LAZY"
	 * )
	 *
	 */
	public $productenGroepen;
