...
class Extra
{
	...
	/**
	 * Het RSIN van de organisatie waartoe deze Extra behoord. Dit moet een geldig RSIN zijn van 9 nummers en voldoen aan https://nl.wikipedia.org/wiki/Burgerservicenummer#11-proef. <br> Het RSIN word bepaald aan de hand van de gauthenticeerde applicatie en kan niet worden overschreven
	 *
	 * @var integer
	 * @ORM\Column(
	 *     type     = "integer",
	...
	/**
	 * Een korte samenvattende tekst over deze Extra bedoeld ter introductie.  <br /><b>Schema:</b> <a href="https://schema.org/description">https://schema.org/description</a>
	 *
	 * @var string
	 *
	 * @ORM\Column(
	...
	/** 
	 * Een uitgebreide beschrijvende tekst over deze Extra bedoeld ter verdere verduidelijking.  <br /><b>Schema:</b> <a href="https://schema.org/description">https://schema.org/description</a>
	 *
	 * @var string
	 *
	 * @ORM\Column(
	...
	{
		return 'http://producten_en_diensten.demo.zaakonline.nl/extras/'.$this->id;
	}
}
